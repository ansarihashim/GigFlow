  ...
  return (
    <div className="min-h-[calc(100vh-72px)] flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-md">
        <h1 className="text-2xl font-semibold text-[#222222] mb-6 text-center">Sign up</h1>
        {error && <div className="mb-4 p-3 bg-red-50 text-red-600 rounded-lg text-sm border border-red-100">{error}</div>}
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="block text-sm text-[#717171] mb-1">Name</label>
            <input
              type="text"
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full bg-[#FF385C] text-white py-3 rounded-lg font-medium hover:bg-[#e03150] transition-colors"
              disabled={loading}
            >
